...
#'/store/user/davidlw/Pythia8_TuneCUETP8M1_5020GeV_PhaseII/QCD_Pt_80_120_GEN_SIM_102X_test_v2/181021_205535/0000/step1_1.root',
...
process.load("MTDHIAnalysis.GenPIDMatching.genpidmatchingjets_cfi")

process.mtdhiana.isETL = cms.untracked.bool(True)
process.mtdhiana.minEtaJet = cms.untracked.double(0)
process.mtdhiana.maxEtaJet = cms.untracked.double(1.6)
process.mtdhiana.minPtJet = cms.untracked.double(70)
#process.mtdhiana.maxPtJet = cms.untracked.double(120)
